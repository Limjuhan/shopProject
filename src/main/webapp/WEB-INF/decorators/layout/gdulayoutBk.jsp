...
@media (max-width: 767px) {
  ...
  .footer .d-flex {
    flex-direction: column; /* 모바일에서 드롭다운 세로 배치 */
    gap: 0.5rem;
  }
}
...
<body>
  ...
  <div class="container">
    ...
    <div class="text-center mb-3">
      <p class="mb-0">
        <i class="fas fa-donut-bite me-2"></i>하나도너츠 | 대표: 김도너츠 | 고객센터: 1234-5678
      </p>
    </div>
    <!-- 구분선 -->
    ...
    <div class="row align-items-center">
      <div class="col-md-6 text-center text-md-start">
        <p class="mb-0">© 2025 하나도너츠. All Rights Reserved.</p>
      </div>
	...
	function exchangeRate2() {
		$.ajax("${path}/ajax/exchange2", {
			success : function(json) {
				console.log(json)
				let html = 
					"<h4 class='w3-center'>수출입은행<br>" + josn.exdate + "</h4>";
